...
AddEventHandler('Badger_Discord_API:PlayerLoaded', function()
	...
	if (tracked[license] == nil) then 
		...
		'welcome to the new ReDux RolePlay, we welcome you to our RolePlay server, we wish you enjoy your stay and we hope you can take time to join our discord on the server page and apply for our BCSO,SASP,SAFD,LSPD and SAEMS, maybe even staff, thank you for joining have a good day/night')
	end
end)
